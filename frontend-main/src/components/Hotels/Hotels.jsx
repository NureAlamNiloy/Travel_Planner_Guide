...
const Hotels = () => {
  ...
  useEffect(() => {
    axios.get('https://scriptsurgeons.pythonanywhere.com/api/hotels/?format=json')
      .then((response) => {
  ...
  const filteredPosts = hotels.filter((post) =>
  ...
  return (
    <div className=" py-10 gap-y-10">
      ...
      (
        <div key={post.id} className="bg-gray-900 bg-opacity-40 text-white relative flex w-full max-w-[26rem] flex-col rounded-xl bg-clip-border shadow-lg">
